...
<div class="flex aspect-square size-8 items-center justify-center rounded-md <?php echo e($companyLogo ? 'bg-white' : 'bg-accent-content text-accent-foreground'); ?>">
    <?php if($companyLogo): ?>
        <img src="<?php echo e($companyLogo); ?>" alt="Company Logo" class="size-7 object-contain rounded">
    <?php else: ?>
...
<div class="ms-1 grid flex-1 text-start text-sm">
    <span class="mb-0.5 truncate leading-tight font-semibold"><?php echo e(\App\Models\Setting::getCompanyName()); ?></span>
</div>
<?php /**PATH D:\School-Projects\Software-dev\Kessly\resources\views\components\app-logo.blade.php ENDPATH**/ ?>