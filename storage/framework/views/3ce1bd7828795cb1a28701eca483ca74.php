...
unset($__errorArgs, $__bag); ?>
    ...
    <!-- View Invoice Modal -->
    <?php if($showView && $viewingInvoice): ?>
        <div class="modal fade show d-block" tabindex="-1" style="background-color: rgba(0, 0, 0, 0.5);">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row g-4">
                            ...
                            <?php if($viewingInvoice->customer): ?>
                                <div class="col-12">
                                    <div class="card bg-label-secondary mb-0">
                                        <div class="card-body">
                                            ...
                                            <div class="row g-3">
                                                <?php if($viewingInvoice->customer->email): ?>
                                                    <div class="col-md-6">
                                                ...
                                                <?php endif; ?>
                                                <?php if($viewingInvoice->customer->phone): ?>
                                                    <div class="col-md-6">
                                                        <small class="text-muted d-block">Phone</small>
                                                        <span><?php echo e($viewingInvoice->customer->phone); ?></span>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if($viewingInvoice->customer->address): ?>
                                                    <div class="col-12">
...
<script>
    ...
    ?>
</div><?php /**PATH D:\School-Projects\Software-dev\Kessly\resources\views\livewire\sales\invoices.blade.php ENDPATH**/ ?>