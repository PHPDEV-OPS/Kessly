...
unset($__errorArgs, $__bag); ?>
    ...
    <!-- View Customer Modal -->
    <?php if($showView && $viewingCustomer): ?>
        <div class="modal fade show d-block" tabindex="-1" style="background-color: rgba(0, 0, 0, 0.5);">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row g-4">
                            ...
                            <?php if($viewingCustomer->address): ?>
                                <div class="col-12">
...
<script>
    ...
    ?>
</div><?php /**PATH D:\School-Projects\Software-dev\Kessly\resources\views\livewire\sales\customers.blade.php ENDPATH**/ ?>