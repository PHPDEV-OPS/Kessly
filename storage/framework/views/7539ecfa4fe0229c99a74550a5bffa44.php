...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                        ...
                        <tr>
                            ...
                            <th>
                                <button wire:click="sortBy('total_spent')" type="button" class="btn btn-sm btn-link text-decoration-none p-0">
                                    Total Spent
                                    <!--[if BLOCK]><![endif]--><?php if($sortField === 'total_spent'): ?>
                                        <i class="ri-arrow-<?php echo e($sortDirection === 'asc' ? 'up' : 'down'); ?>-s-line"></i>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </button>
                            </th>
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <!--[if BLOCK]><![endif]--><?php if($customer->avatar): ?>
        ...
        <!-- Pagination -->
        <!--[if BLOCK]><![endif]--><?php if($this->customers->hasPages()): ?>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['customer_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center">
                                        <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->avatar): ?>
                                        ...
                                        <div>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->company): ?>
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->mobile): ?>
                                            <div class="mb-3">
                                                <small class="text-muted d-block">Mobile</small>
                                                <span><?php echo e($selectedCustomer->mobile); ?></span>
                                            </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->website): ?>
                                            <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->address): ?>
                                            <div class="mb-2"><?php echo e($selectedCustomer->address); ?></div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <div>
                                            <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->city): ?><?php echo e($selectedCustomer->city); ?><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->state): ?>, <?php echo e($selectedCustomer->state); ?><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->postal_code): ?> <?php echo e($selectedCustomer->postal_code); ?><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </div>
                                        <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->country): ?>
                                            <div class="mt-2"><?php echo e($selectedCustomer->country); ?></div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <!--[if BLOCK]><![endif]--><?php if(!$selectedCustomer->address && !$selectedCustomer->city && !$selectedCustomer->state): ?>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->tax_id): ?>
                                                <div class="col-md-4 mb-3">
                                                    <small class="text-muted d-block">Tax ID</small>
                                                    <span><?php echo e($selectedCustomer->tax_id); ?></span>
                                                </div>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->payment_terms): ?>
                                                <div class="col-md-4 mb-3">
                            ...
                            <!-- Notes -->
                            <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->notes): ?>
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                            ...
                            <!-- Tags -->
                            <!--[if BLOCK]><![endif]--><?php if($selectedCustomer->tags && count($selectedCustomer->tags) > 0): ?>
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                        ...
                                        <div class="card-body">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedCustomer->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
