...
<div>
        ...
        <div class="card-body p-0">
            <nav class="nav nav-pills nav-justified" role="tablist">
                <button wire:click="setActiveTab('business')" type="button"
                    class="nav-link <?php echo e($activeTab === 'business' ? 'active' : ''); ?> rounded-0 border-0 d-flex align-items-center justify-content-center py-3">
                ...
                <button wire:click="setActiveTab('performance')" type="button"
                    class="nav-link <?php echo e($activeTab === 'performance' ? 'active' : ''); ?> rounded-0 border-0 d-flex align-items-center justify-content-center py-3">
                    <div class="text-center">
                ...
                <button wire:click="setActiveTab('reports')" type="button"
                    class="nav-link <?php echo e($activeTab === 'reports' ? 'active' : ''); ?> rounded-0 border-0 d-flex align-items-center justify-content-center py-3">
                    <div class="text-center">
    ...
    <div class="tab-content">
        <div class="tab-pane fade <?php echo e($activeTab === 'business' ? 'show active' : ''); ?>">
            <!--[if BLOCK]><![endif]--><?php if($activeTab === 'business'): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('analytics.business-analytics', []);

$__html = app('livewire')->mount($__name, $__params, 'business-'.now(), $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div class="tab-pane fade <?php echo e($activeTab === 'performance' ? 'show active' : ''); ?>">
            <!--[if BLOCK]><![endif]--><?php if($activeTab === 'performance'): ?>
                <div class="card">
        ...
        <div class="tab-pane fade <?php echo e($activeTab === 'reports' ? 'show active' : ''); ?>">
            <!--[if BLOCK]><![endif]--><?php if($activeTab === 'reports'): ?>
                <div class="card">
                    <div class="card-body text-center py-5">
                        <div class="mb-3">
...
</div><?php /**PATH D:\School-Projects\Software-dev\Kessly\resources\views\livewire/pages/analytics.blade.php ENDPATH**/ ?>