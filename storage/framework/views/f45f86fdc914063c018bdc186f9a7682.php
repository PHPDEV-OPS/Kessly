                ...
                <tr>
                    ...
                    <th>
                        <button type="button" class="btn btn-sm btn-link text-decoration-none p-0 d-flex align-items-center gap-1" wire:click="sortBy('order_date')">
                            Date
                            <!--[if BLOCK]><![endif]--><?php if($sortField === 'order_date'): ?>
                                <i class="ri-<?php echo e($sortDirection === 'asc' ? 'arrow-up' : 'arrow-down'); ?>-s-line text-primary"></i>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </button>
                    </th>
            ...
            <tbody>
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td data-label="Customer"><?php echo e($order->customer?->name ?? '—'); ?></td>
                        <td data-label="Date"><?php echo e(optional($order->order_date)->format('M d, Y')); ?></td>
                        <td data-label="Total"><span class="fw-semibold">Ksh <?php echo e(number_format($order->total_amount, 2)); ?></span></td>
...
unset($__errorArgs, $__bag); ?>" wire:model.defer="order_number">
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['order_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!-- View Order Modal -->
    <!--[if BLOCK]><![endif]--><?php if($showView && $viewingOrder): ?>
        <div class="modal fade show d-block" tabindex="-1" style="background-color: rgba(0, 0, 0, 0.5);">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="row g-4">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($viewingOrder->customer): ?>
                                <div class="col-12">
                                    <div class="card bg-label-secondary mb-0">
                                        <div class="card-body">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                                <!--[if BLOCK]><![endif]--><?php if($viewingOrder->customer->address): ?>
                                                    <div class="col-12">
