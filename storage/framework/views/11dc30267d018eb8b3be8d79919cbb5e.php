<div>
    ...
    <div wire:loading.remove.delay id="stockReportContent">
        ...
        <!-- Stock Alerts -->
        <?php if(count($alerts['danger']) > 0 || count($alerts['warning']) > 0): ?>
                            ...
                            <div class="d-flex align-items-start p-3 bg-danger bg-opacity-10">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <?php $__currentLoopData = $alerts['danger']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="alert-section">
                            <div class="d-flex align-items-start p-3 bg-warning bg-opacity-10">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <?php $__currentLoopData = $alerts['warning']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            waitForApexCharts(initStockCharts);
        });
...
</div><?php /**PATH D:\School-Projects\Software-dev\Kessly\resources\views\livewire\reports\stock-report.blade.php ENDPATH**/ ?>