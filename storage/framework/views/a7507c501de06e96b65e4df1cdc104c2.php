        ...
        <div class="bg-background flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
            <div class="flex w-full max-w-sm flex-col gap-2">
                <a href="<?php echo e(route('home')); ?>" class="flex flex-col items-center gap-2 font-medium" wire:navigate>
                    ...
                    <span class="flex h-9 w-9 mb-1 items-center justify-center rounded-md <?php echo e($companyLogo ? 'bg-white border border-gray-200' : ''); ?>">
                        <?php if($companyLogo): ?>
...
<?php /**PATH D:\School-Projects\Software-dev\Kessly\resources\views\components\layouts\auth\simple.blade.php ENDPATH**/ ?>