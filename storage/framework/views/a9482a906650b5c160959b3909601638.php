            ...
            <div class="card card-border-shadow-primary h-100">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <?php if($comparisonMode && $comparisonMetrics): ?>
                            <?php
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $branchAnalytics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
