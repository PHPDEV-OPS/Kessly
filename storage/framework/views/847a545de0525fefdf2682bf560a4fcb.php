<div>
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-end gap-2 mb-4">
        ...
        <a 
            href="<?php echo e(route('inventory')); ?>" 
            wire:navigate
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="mb-1"><?php echo e(number_format($analytics['total_products'])); ?></h5>
                    <p class="mb-2 text-muted">Products</p>
                    <!--[if BLOCK]><![endif]--><?php if($analytics['out_of_stock_count'] > 0): ?>
                        <small class="text-warning"><?php echo e($analytics['out_of_stock_count']); ?> out of stock</small>
                    <?php else: ?>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="mb-1">$<?php echo e(number_format($analytics['revenue_30_days'], 0)); ?></h5>
                    <p class="mb-2 text-muted">Revenue</p>
                    <small class="text-success">Today: $<?php echo e(number_format($analytics['revenue_today'], 2)); ?></small>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="mb-1"><?php echo e(number_format($analytics['total_orders'])); ?></h5>
                    <p class="mb-2 text-muted">Orders</p>
                    <small class="text-info">Today: <?php echo e($analytics['orders_today']); ?> orders</small>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($analytics['low_stock_count'] > 0): ?>
                            <span class="badge bg-label-danger">Alert</span>
                        <?php else: ?>
                            <span class="badge bg-label-success">Good</span>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </div>
                    <h5 class="mb-1"><?php echo e($analytics['low_stock_count']); ?></h5>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0"><?php echo e(number_format($analytics['total_customers'])); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0"><?php echo e(number_format($analytics['total_categories'])); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="mb-0"><?php echo e(number_format($analytics['total_suppliers'])); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <!--[if BLOCK]><![endif]--><?php if($analytics['monthly_revenue_trend']->count() > 0): ?>
                            ...
                            <div class="col-md-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="mb-0">$<?php echo e(number_format($analytics['revenue_today'], 0)); ?></h5>
                            ...
                            <div class="col-md-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="mb-0">$<?php echo e(number_format($analytics['revenue_7_days'], 0)); ?></h5>
                            ...
                            <div class="col-md-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <h5 class="mb-0">$<?php echo e(number_format($analytics['revenue_30_days'], 0)); ?></h5>
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $analytics['top_selling_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            ?>
                            <li class="mb-3 pb-3 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?> product-item">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-0"><?php echo e(Str::limit($product->name ?? 'Unknown Product', 25)); ?></h6>
                                        <small class="text-muted">
                                            <i class="ri-shopping-cart-line me-1"></i><?php echo e($product->total_sold ?? 0); ?> sold
                                        </small>
                                    </div>
                                    <div class="text-end">
                                        <h6 class="mb-0">$<?php echo e(number_format($product->price ?? 0, 2)); ?></h6>
                                        <!--[if BLOCK]><![endif]--><?php if($product->total_sold ?? 0 > 0): ?>
                                            <small class="text-success">
                                                <i class="ri-arrow-up-line"></i>
                                                $<?php echo e(number_format($productRevenue, 0)); ?>
                                ...
                                <div class="progress" style="height: 4px;">
                                    <div class="progress-bar 
                                        ...
                                        <?php elseif($index == 1): ?> bg-info
                                        <?php elseif($index == 2): ?> bg-secondary
                                        <?php else: ?> bg-primary
                                        <?php endif; ?>" 
                                        role="progressbar" 
                                        style="width: <?php echo e($percentage); ?>%; transition: width 1s ease-in-out;" 
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <a href="<?php echo e(route('sales')); ?>" wire:navigate class="btn btn-sm btn-label-primary">
                        <i class="ri-arrow-right-line"></i>
                    </a>
                </div>
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $analytics['recent_orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="mb-3 pb-3 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            ...
                                            <span class="badge bg-label-success">$<?php echo e(number_format($order->total_amount, 2)); ?></span>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <small class="text-muted me-2">
                                                <i class="ri-user-line me-1"></i><?php echo e(Str::limit($order->customer?->name ?? 'Guest', 20)); ?>

                                            </small>
                                            <small class="text-muted">
                                                <i class="ri-time-line me-1"></i><?php echo e($order->order_date?->diffForHumans()); ?>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $analytics['recent_invoices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="mb-3 pb-3 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                                <div class="d-flex align-items-start">
                                    <div class="avatar avatar-sm flex-shrink-0 me-3">
                                        <div class="avatar-initial bg-label-success rounded">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <h6 class="mb-0"><?php echo e($invoice->name); ?></h6>
                                            <span class="badge bg-label-primary">$<?php echo e(number_format($invoice->amount, 2)); ?></span>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <small class="text-muted me-2">
                                                <i class="ri-user-line me-1"></i><?php echo e(Str::limit($invoice->customer?->name ?? 'No customer', 20)); ?>

                                            </small>
                                            <small class="text-muted">
                                                <i class="ri-time-line me-1"></i><?php echo e($invoice->created_at?->diffForHumans()); ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($analytics['low_stock_count'] > 0): ?>
        <div class="card border-warning">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0 text-muted small">
                                <i class="ri-box-3-line me-1"></i><?php echo e($analytics['low_stock_count']); ?> product<?php echo e($analytics['low_stock_count'] > 1 ? 's' : ''); ?> need<?php echo e($analytics['low_stock_count'] == 1 ? 's' : ''); ?> restocking
                            </p>
                        </div>
                    </div>
                    <a href="<?php echo e(route('inventory')); ?>" wire:navigate class="btn btn-sm btn-warning">
                        <i class="ri-stack-line me-1"></i>
                        Manage Inventory
                    </a>
                </div>
            ...
            <div class="card-body">
                <div class="row g-3">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $analytics['low_stock_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center p-3 border rounded hover-shadow-sm">
                                ...
                                <div class="flex-grow-1 me-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <small class="text-muted me-2">
                                            <i class="ri-price-tag-3-line me-1"></i><?php echo e($product->category?->name ?? 'No category'); ?>
                                ...
                                <div class="text-end flex-shrink-0">
                                    <!--[if BLOCK]><![endif]--><?php if($product->stock === 0): ?>
                                        ...
                                        <div><small class="text-danger fw-bold"><?php echo e($product->stock); ?> units</small></div>
                                    <?php elseif($product->stock <= 2): ?>
                                        <span class="badge bg-warning mb-1">CRITICAL</span>
                                        <div><small class="text-warning fw-bold"><?php echo e($product->stock); ?> unit<?php echo e($product->stock > 1 ? 's' : ''); ?></small></div>
                                    <?php else: ?>
                                        <span class="badge bg-info mb-1">LOW STOCK</span>
                                        <div><small class="text-info fw-bold"><?php echo e($product->stock); ?> units</small></div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\School-Projects\Software-dev\Kessly\resources\views/livewire/dashboard.blade.php ENDPATH**/ ?>