                                ...
                                <tbody>
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="text-end"><?php echo e(number_format($product->total_orders)); ?></td>
                                            <td class="text-end fw-semibold">$<?php echo e(number_format($product->total_revenue, 2)); ?></td>
                                        </tr>
                                ...
                                <tbody>
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="text-end"><?php echo e(number_format($customer->total_orders)); ?></td>
                                            <td class="text-end fw-semibold">$<?php echo e(number_format($customer->total_spent, 2)); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
                                            <td colspan="3" class="text-center text-muted">No data available</td>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><span class="badge bg-label-secondary">#<?php echo e($order->id); ?></span></td>
                                    <td><?php echo e($order->customer?->name ?? 'Walk-in'); ?></td>
                                    <td><?php echo e($order->created_at->format('M d, Y')); ?></td>
                                    <td><?php echo e($order->order_items_count); ?> items</td>
                                    <td class="text-end fw-semibold">$<?php echo e(number_format($order->total_amount, 2)); ?></td>}}</td>
                                    <td>
