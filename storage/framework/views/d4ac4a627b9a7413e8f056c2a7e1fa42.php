            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-3">
                    ...
                    <select wire:model.live="selectedCustomer" class="form-select">
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = \App\Models\Customer::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <h4 class="mb-0"><?php echo e(number_format($summary['total_orders'])); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <h4 class="mb-0">$<?php echo e(number_format($summary['total_revenue'], 2)); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <h4 class="mb-0">$<?php echo e(number_format($summary['avg_order_value'], 2)); ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-stacked">
                                ...
                                <tbody>
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="text-end" data-label="Orders"><?php echo e(number_format($product->total_orders)); ?></td>
                                            <td class="text-end fw-semibold" data-label="Revenue">$<?php echo e(number_format($product->total_revenue, 2)); ?></td>
                                        </tr>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-stacked">
                                ...
                                <tbody>
                                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $topCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="text-end" data-label="Orders"><?php echo e(number_format($customer->total_orders)); ?></td>
                                            <td class="text-end fw-semibold" data-label="Total Spent">$<?php echo e(number_format($customer->total_spent, 2)); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
                                            <td colspan="3" class="text-center text-muted">No data available</td>
                    ...
                    <table class="table table-hover table-stacked">
                        ...
                        <tbody>
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td data-label="Order ID"><span class="badge bg-label-secondary">#<?php echo e($order->id); ?></span></td>
                                    <td data-label="Customer"><?php echo e($order->customer?->name ?? 'Walk-in'); ?></td>
                                    <td data-label="Date"><?php echo e($order->created_at->format('M d, Y')); ?></td>
                                    <td data-label="Items"><?php echo e($order->order_items_count); ?> items</td>
                                    <td class="text-end fw-semibold" data-label="Amount">$<?php echo e(number_format($order->total_amount, 2)); ?></td>}}</td>
...
<?php /**PATH D:\School-Projects\Software-dev\Kessly\resources\views/livewire/reports/sales-report.blade.php ENDPATH**/ ?>