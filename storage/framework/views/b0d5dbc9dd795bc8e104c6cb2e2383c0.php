    ...
    <div class="card mb-4">
        <div class="card-body p-0">
            ...
            <thead>
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td data-label="Name">
                                <div class="d-flex align-items-center">
                            ...
                            <td data-label="Email">
                                <!--[if BLOCK]><![endif]--><?php if($sup->contact_email): ?>
                            ...
                            <td data-label="Phone">
                                <!--[if BLOCK]><![endif]--><?php if($sup->phone): ?>
                            ...
                            <td data-label="Address"><?php echo e($sup->address ?? '—'); ?></td>
...
unset($__errorArgs, $__bag); ?>" wire:model.defer="contact_email" placeholder="email@example.com">
                                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['contact_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="invalid-feedback"><?php echo e($message); ?></div> <?php unset($message);
...
<?php /**PATH D:\School-Projects\Software-dev\Kessly\resources\views/livewire/inventory/suppliers.blade.php ENDPATH**/ ?>