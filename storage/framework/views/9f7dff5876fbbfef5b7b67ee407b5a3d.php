...
<div>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade <?php echo e($activeTab === 'company' ? 'show active' : ''); ?>">
            <!--[if BLOCK]><![endif]--><?php if($activeTab === 'company'): ?>
                <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw-744636589-0', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div class="tab-pane fade <?php echo e($activeTab === 'system' ? 'show active' : ''); ?>">
            <!--[if BLOCK]><![endif]--><?php if($activeTab === 'system'): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-744636589-1', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div class="tab-pane fade <?php echo e($activeTab === 'users' ? 'show active' : ''); ?>">
            <!--[if BLOCK]><![endif]--><?php if($activeTab === 'users'): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-744636589-2', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <div class="tab-pane fade <?php echo e($activeTab === 'security' ? 'show active' : ''); ?>">
            <!--[if BLOCK]><![endif]--><?php if($activeTab === 'security'): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
...
$__html = app('livewire')->mount($__name, $__params, 'lw-744636589-3', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-744636589-4', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-744636589-5', $__slots ?? [], get_defined_vars());
