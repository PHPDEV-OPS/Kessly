<div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php if($analytics['out_of_stock_count'] > 0): ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <?php if($analytics['low_stock_count'] > 0): ?>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <?php if($analytics['monthly_revenue_trend']->count() > 0): ?>
                        ...
                        <script>
                            ...
                            document.addEventListener('livewire:navigated', function () {
                                waitForApexCharts(initRevenueChart);
                            });
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <?php $__empty_1 = true; $__currentLoopData = $analytics['top_selling_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <?php $__empty_1 = true; $__currentLoopData = $analytics['recent_orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0">
                        <?php $__empty_1 = true; $__currentLoopData = $analytics['recent_invoices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="mb-3 pb-3 <?php echo e(!$loop->last ? 'border-bottom' : ''); ?>">
                                <div class="d-flex align-items-start">
                                    <div class="avatar avatar-sm flex-shrink-0 me-3">
                                        <div class="avatar-initial bg-label-success rounded">
    ...
    <?php if($analytics['low_stock_count'] > 0): ?>
        <div class="card border-warning">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <?php $__currentLoopData = $analytics['low_stock_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-6">
...
<?php $__env->stopPush(); ?><?php /**PATH D:\School-Projects\Software-dev\Kessly\resources\views\livewire\dashboard.blade.php ENDPATH**/ ?>