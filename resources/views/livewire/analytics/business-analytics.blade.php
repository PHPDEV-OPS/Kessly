<div>
    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4 mb-3">
            <div class="alert alert-{{ $insight['type'] === 'positive' ? 'success' : ($insight['type'] === 'negative' ? 'danger' : ($insight['type'] === 'warning' ? 'warning' : 'info')) }} d-flex align-items-center mb-0" role="alert">
                <i class='bx bx-{{ $insight['icon'] }} fs-4 me-2'></i>
                <div>
            ...
            <div class="card card-border-shadow-primary h-100">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <h3 class="mb-0 me-2">${{ number_format($metrics['total_revenue'] ?? 0, 2) }}</h3>
                        @if($comparisonMode && $comparisonMetrics)
                            @php
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card card-border-shadow-success h-100">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <h3 class="mb-0 me-2">{{ number_format($metrics['total_orders'] ?? 0) }}</h3>
                        @if($comparisonMode && $comparisonMetrics)
                            @php
        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card card-border-shadow-warning h-100">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <h3 class="mb-0">${{ number_format($metrics['average_order_value'] ?? 0, 2) }}</h3>
                    </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h4 class="mb-0">{{ number_format($metrics['total_products_sold'] ?? 0) }}</h4>
                        </div>
                        <div class="avatar">
                            <span class="avatar-initial rounded bg-label-primary">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h4 class="mb-0">${{ number_format($metrics['inventory_value'] ?? 0, 2) }}</h4>
                        </div>
                        <div class="avatar">
                            <span class="avatar-initial rounded bg-label-success">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h4 class="mb-0 text-warning">{{ number_format($metrics['low_stock_items'] ?? 0) }}</h4>
                        </div>
                        <div class="avatar">
                            <span class="avatar-initial rounded bg-label-warning">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <h4 class="mb-0">{{ number_format($hrAnalytics['total_employees'] ?? 0) }}</h4>
                        </div>
                        <div class="avatar">
                            <span class="avatar-initial rounded bg-label-info">
                        ...
                        <div class="col-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h5 class="mb-0">{{ $hrAnalytics['total_employees'] ?? 0 }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h5 class="mb-0">{{ $hrAnalytics['total_managers'] ?? 0 }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h5 class="mb-0">{{ number_format($hrAnalytics['average_attendance_rate'] ?? 0, 1) }}%</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h5 class="mb-0">${{ number_format($hrAnalytics['total_payroll_cost'] ?? 0, 0) }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 mt-3">
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar bg-success" role="progressbar" 
                                     style="width: {{ $hrAnalytics['average_attendance_rate'] ?? 0 }}%" 
                                     aria-valuenow="{{ $hrAnalytics['average_attendance_rate'] ?? 0 }}" 
                        ...
                        <div class="col-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h5 class="mb-0">${{ number_format($financialAnalytics['total_budget_allocated'] ?? 0, 0) }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h5 class="mb-0">${{ number_format($financialAnalytics['total_expenses'] ?? 0, 0) }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h5 class="mb-0">{{ number_format($financialAnalytics['budget_utilization'] ?? 0, 1) }}%</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <h5 class="mb-0">${{ number_format($financialAnalytics['payroll_expenses'] ?? 0, 0) }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 mt-3">
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar bg-{{ ($financialAnalytics['budget_utilization'] ?? 0) > 80 ? 'danger' : 'primary' }}" 
                                     role="progressbar" 
                                     style="width: {{ min($financialAnalytics['budget_utilization'] ?? 0, 100) }}%" 
                                     aria-valuenow="{{ $financialAnalytics['budget_utilization'] ?? 0 }}" 
                                     aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        @forelse($branchAnalytics as $index => $branch)
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-sm me-3">
                                            <span class="avatar-initial rounded-circle bg-label-{{ ['primary', 'success', 'info', 'warning'][$index % 4] }}">
                                ...
                                <td>
                                    <span class="badge bg-label-info">{{ $branch['employees_count'] }}</span>
                                </td>
                                <td>{{ number_format($branch['orders_count']) }}</td>
                                <td>
                                    <strong class="text-success">${{ number_format($branch['revenue'], 2) }}</strong>
                                </td>
                                <td>
                                    @php
    ...
    <script>
        ...
        (function() {
            ...
            function initRevenueChart() {
                const revenueTrend = @json($trends['revenue_trend'] ?? []);
            ...
            function initTopProductsChart() {
                const topProducts = @json($trends['top_products'] ?? []);
            ...
            function initOrdersChart() {
                const orderTrend = @json($trends['order_trend'] ?? []);
            ...
            function initDepartmentChart() {
                const departments = @json($hrAnalytics['departments'] ?? []);
