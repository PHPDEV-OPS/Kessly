...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Human Resources</h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage employees, attendance, and HR operations</p>
        </div>
    </div>
        ...
        <div class="p-6">
            ...
            @elseif($activeTab === 'departments')
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Department organization and hierarchy coming soon.</p>
                </div>
            @endif
        </div>
    </div>
