                        ...
                        <form wire:submit="register" action="#" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input wire:model="name" type="text" class="form-control" placeholder="Your full name" id="name" autofocus required>
                                </div>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input wire:model="email" type="email" class="form-control" placeholder="example@company.com" id="email" required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="password_confirmation" type="password" placeholder="Confirm Password" class="form-control" id="password_confirmation" required>
                                    </div>
