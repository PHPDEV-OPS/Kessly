...
<main>
    ...
    <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            <p class="text-center">
                <a href="{{ route('dashboard') }}" class="d-flex align-items-center justify-content-center" wire:navigate>
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            ...
                            <p class="mb-0">Sign in to your Kessly SCM account</p>
                        </div>
                        ...
                        <form wire:submit="login" action="#" class="mt-4" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input wire:model="form.email" type="email" class="form-control" placeholder="example@company.com" id="email" autofocus required>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="form.password" type="password" placeholder="Password" class="form-control" id="password" required>
                                    </div>
                                ...
                                <div class="d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    @if (Route::has('password.request'))
                                        <div><a href="{{ route('password.request') }}" class="small text-right" wire:navigate>Lost password?</a></div>
                                    @endif
                                </div>
                            </div>
                            <div class="d-grid">
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                            <span class="fw-normal">
                                Not registered?
                                <a href="{{ route('register') }}" class="fw-bold" wire:navigate>Create account</a>
                            </span>
                        </div>
                    </div>
                </div>
