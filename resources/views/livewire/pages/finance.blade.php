                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h5 class="mb-0">{{ \App\Models\Payroll::count() }}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h5 class="mb-0 text-success">{{ \App\Models\Payroll::where('status', 'processed')->count() }}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h5 class="mb-0">{{ \App\Models\Budget::count() }}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h5 class="mb-0 text-warning">{{ \App\Models\Expense::where('status', 'pending')->count() }}</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <button wire:click.prevent="setActiveTab('payroll')" 
                        class="nav-link {{ $activeTab === 'payroll' ? 'active' : '' }}" 
                        type="button">
            ...
            <li class="nav-item">
                <button wire:click.prevent="setActiveTab('budgets')" 
                        class="nav-link {{ $activeTab === 'budgets' ? 'active' : '' }}" 
                        type="button">
            ...
            <li class="nav-item">
                <button wire:click.prevent="setActiveTab('expenses')" 
                        class="nav-link {{ $activeTab === 'expenses' ? 'active' : '' }}" 
                        type="button">
