...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Comprehensive business insights and analytics</p>
        </div>
    </div>
        ...
        <div class="p-6">
            ...
            @elseif($activeTab === 'performance')
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Detailed performance analysis and KPI tracking.</p>
                </div>
            @elseif($activeTab === 'reports')
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Generate custom reports and export data.</p>
                </div>
            @endif
        </div>
    </div>
