...
<div>
    <!-- Page Navigation -->
    <x-page-navigation title="Branch Management" description="Manage branch operations and inventory" :breadcrumbs="[
        ['title' => 'Branches']
    ]" />
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
            <div class="border-b border-gray-200 dark:border-gray-700">
                <nav class="flex space-x-8 px-6" aria-label="Tabs">
                    <button wire:click="setActiveTab('branches')"
                    ...
                    <button wire:click="setActiveTab('transfers')"
            ...
            <div class="p-6">
                ...
                @elseif($activeTab === 'transfers')
                    <div class="text-center py-12">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Manage inventory transfers between
                            branches.</p>
                    </div>
                @endif
            </div>
