        ...
        <div class="p-6">
            ...
            @elseif($activeTab === 'company')
                <div class="text-center py-8">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mt-2">Company profile management is being enhanced. Please use the existing profile settings for now.</p>
                </div>
            @elseif($activeTab === 'security')
                <div class="text-center py-8">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Security Settings</h3>
                    <p class="text-gray-600 dark:text-gray-400 mt-2">Advanced security settings are being configured. Basic security is handled through the password tab.</p>
                </div>
            @elseif($activeTab === 'email')
                <div class="text-center py-8">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Email & Notifications</h3>
                    <p class="text-gray-600 dark:text-gray-400 mt-2">Email configuration panel is being enhanced for better usability.</p>
                </div>
            @elseif($activeTab === 'business')
                <div class="text-center py-8">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Business Rules</h3>
                    <p class="text-gray-600 dark:text-gray-400 mt-2">Business logic configuration is being optimized for your operations.</p>
                </div>
            @endif
        </div>
    </div>
